    ...
    <>
      ...
      <div className="xs:px-8 px-2">
        <div className="flex items-center gap-4 mb-8">
          <Link className="bg-white border border-subMain border-dashed rounded-lg py-3 px-4 text-md" href="/doctors">
          ...
          <h1 className="text-xl font-semibold">Create Doctor</h1>
        </div>
