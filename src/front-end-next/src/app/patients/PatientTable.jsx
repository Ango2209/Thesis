        ...
        <div className="p-6 bg-white rounded-lg shadow-md">
          <div className="flex flex-col md:flex-row items-center justify-between mb-4">
            <input
              ...
              className="mb-2 md:mb-0 md:mr-2 px-4 py-2 border rounded-lg focus:outline-none focus:ring focus:border-blue-300"
            />
            <div className="flex flex-col md:flex-row space-x-0 md:space-x-2 mb-2 md:mb-0">
              <select className="mb-2 md:mb-0 px-4 py-2 border rounded-lg focus:outline-none focus:ring focus:border-blue-300">
              ...
              <input
                type="date"
                className="mb-2 md:mb-0 px-4 py-2 border rounded-lg focus:outline-none focus:ring focus:border-blue-300"
              />
            </div>
      ...
      <div className="mt-8">
        <ReactPaginate
          ...
          previousLinkClassName={
            "px-4 py-2 bg-gray-200 hover:bg-gray-300 rounded-md text-gray-600 transition"
          }
          nextLinkClassName={
            "px-4 py-2 bg-gray-200 hover:bg-gray-300 rounded-md text-gray-600 transition"
          }
          ...
          pageLinkClassName={
            "px-3 py-2 border border-gray-300 rounded-md hover:bg-gray-100 transition"
          }
        />
      </div>
    </div>
