    ...
    <div style={containerStyle}>
      ...
      <div style={serviceContainerStyle}>
        ...
        <table style={tableStyle}>
          ...
          <tbody>
            {service.medicines.map((medicine, index) => ( // Updated to map through medicines
              <tr key={index}>
                <td style={tableCellStyle}>{medicine.name}</td>
                <td style={tableCellStyle}>{medicine.price} ₫</td>
                <td style={tableCellStyle}>{medicine.quantity}</td>
              </tr>
            ))}
          </tbody>
        </table>
