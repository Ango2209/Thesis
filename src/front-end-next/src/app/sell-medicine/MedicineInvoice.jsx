  ...
  return (
    <div style={invoiceContainerStyle}>
        ...
        <table style={tableStyle}>
          ...
          <tbody>
            {medicines.map((medicine, index) => (
              <tr key={index}>
                <td style={tableCellStyle}>{medicine.name}</td>
                <td style={tableCellStyle}>{medicine.basePrice} ₫</td>
                <td style={tableCellStyle}>{medicine.quantityToUse}</td>
                <td style={tableCellStyle}>{medicine.basePrice * medicine.quantityToUse} ₫</td>
              </tr>
            ))}
          </tbody>
        </table>
      ...
      <div style={totalContainerStyle}>
        <h4>Total Amount</h4>
        <p style={totalAmountStyle}>{totalAmount} ₫</p>
      </div>
