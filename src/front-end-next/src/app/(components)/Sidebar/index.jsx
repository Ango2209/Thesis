...
import { CalendarDays, CircleDollarSign, GraduationCap, House, Pill, ReceiptCent, Settings, Users, Newspaper } from "lucide-react";
  ...
  return (
    <div className={sidebarClassNames}>
      ...
      <div className="flex-grow mt-8">
        ...
        <SidebarLink href="/blog" icon={Newspaper} label="Blob" isCollapsed={isSidebarCollapsed} />
        <SidebarLink href="/settings" icon={Settings} label="Settings" isCollapsed={isSidebarCollapsed} />
      </div>

      {/* FOOTER */}
      <div className={`${isSidebarCollapsed ? "hidden" : "block"} mb-10`}>
        <p className="text-center text-xs text-gray-500">&copy; 2024 NgoSangHeathCare</p>
      </div>
    </div>
  );
};
