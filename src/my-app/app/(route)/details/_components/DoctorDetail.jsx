...
function DoctorDetail({ recordId }) {
  ...
  if (!patient) return null; // Render nothing if patient is not found in localStorage

  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-3 border-[1px] p-5 mt-5 rounded-lg">
        {/* Doctor Image */}
        <div>{doctor && <Image src={`/${doctor?.avatar}`} width={200} height={200} alt="doctor-image" className="rounded-lg h-[270px] object-cover" />}</div>
        {/* Doctor Info */}
      ...
      <div className="p-3 border-[1px] rounded-lg mt-5">
        ...
        <p className="text-gray-500 tracking-wide mt-2">
          ...
          individual receives personalized attention. I specialize in key areas
          of expertise or focus and am passionate about helping my patients
          achieve optimal health and well-being. My philosophy centers around
          understanding my patients' unique needs, fostering open communication,
          and empowering them with the knowledge they need to make informed
